        ...
        try {
            ...
            Object.entries(groupedTasks).forEach(([group, groupTasks]) => {
                ...
                groupTasks.forEach(task => {
                    ...
                    const status = task.is_done ? "[x]" : "[ ]"
                    doc.text(`${status}  ${task.title}`, 25, yPos)
                    yPos += 8
                })
        ...
        try {
            ...
            const children = [
                ...
                new Paragraph({
                    ...
                    spacing: { after: 500 },
                    style: "Subtitle" // Optional if utilizing styles
                })
            ]
            ...
            Object.entries(groupedTasks).forEach(([group, groupTasks]) => {
                children.push(
                    new Paragraph({
                        ...
                        heading: HeadingLevel.HEADING_1, // Big and Bold as requested
